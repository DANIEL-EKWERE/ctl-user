...
class ApiClient {
  static const String _baseUrl = 'https://ctl.elianaeliohotels.com/api';
  ...
  Future<Map<String, String>> _authHeaders() async {
    ...
    return {
      ...
      'Accept': 'application/json',
      'Authorization':
          'Bearer 184|kxTOaRMRZh1VOttzNv90O774Z29d9PpQOcpGkdzj9b08ef72',
    };
  }
  ...
  Future<Map<String, dynamic>> _get(
    ...
    var url = Uri.parse('$_baseUrl/ctl/$path');
  ...
  Future<Map<String, dynamic>> getVendorDetail(int vendorId) =>
      _get('customer/vendors/$vendorId');
  ...
  Future<Map<String, dynamic>> getProfile() => _get('fetch-user');
