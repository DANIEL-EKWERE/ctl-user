        ...
        Padding(
          ...
          child: Row(children: [
            Container(width: 28, height: 28,
              ...
              child: const Center(child: Icon(Icons.store_outlined, size: 16, color: AppColors.navy))),
    ...
    child: Row(children: [
      item.imageUrl != null && item.imageUrl!.isNotEmpty
          ...
          : Container(width: 44, height: 44,
              ...
              child: const Center(child: Icon(Icons.fastfood_outlined, size: 20, color: AppColors.orange))),
