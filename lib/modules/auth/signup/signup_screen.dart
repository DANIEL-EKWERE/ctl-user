        ...
        () => Column(
          ...
          children: [
            ...
            AppInput(
              ...
              onChanged: (v) => _ctrl.signupEmail.value = v,
            ),
            const SizedBox(height: 14),
            AppInput(
              label: 'Phone number',
              ...
              onChanged: (v) => _ctrl.signupPhone.value = v,
            ),
            const SizedBox(height: 14),
            AppInput(
              label: 'Password',
              ...
              obscure: _obscure,
              onChanged: (v) => _ctrl.signupPass.value = v,
              suffix: IconButton(
                icon: Icon(
            ...
            AppInput(
              ...
              obscure: _obscure,
              onChanged: (v) => _ctrl.signupPassConf.value = v,
            ),
  ...
  Widget _roleBtn(String value, String label) => Expanded(
    child: GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _ctrl.signupRole.value == value
              ? AppColors.navy
              : Colors.transparent,
