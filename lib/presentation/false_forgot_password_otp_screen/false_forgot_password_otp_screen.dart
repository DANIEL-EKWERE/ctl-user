...
import 'controller/false_forgot_password_otp_controller.dart'; // ignore_for_file: must_be_immutable

class FalseForgotPasswordOtpScreen
    extends GetWidget<FalseForgotPasswordOtpController> {
                ...
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      ...
                      style: CustomTextStyles.labelMediumMontOnPrimaryContainer,
                    ),
                  ],
                ),
                textAlign: TextAlign.left,
  ...
  /// Navigates to the forgotPasswordOtpScreen when the action is triggered.
  onTapSubmit() {
