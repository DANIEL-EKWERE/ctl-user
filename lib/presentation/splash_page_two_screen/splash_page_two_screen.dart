...
import 'controller/splash_page_two_controller.dart'; // ignore_for_file: must_be_immutable
...
class SplashPageTwoScreen extends GetWidget<SplashPageTwoController> {
  ...
  /// Navigates to the splashPageThreeScreen when the action is triggered.
  onTapTxtNextone() {
    Get.toNamed(AppRoutes.splashPageThreeScreen);
  }
}
