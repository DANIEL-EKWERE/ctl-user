...
class SignupOneScreen extends GetWidget<SignupOneController> {
  ...
  /// Section Widget
  Widget _buildFullnameone() {
    return Padding(
      padding: EdgeInsets.only(right: 2.h),
      child: CustomTextFormField(
        controller: controller.fullnameoneController,
        hintText: "lbl_jacob".tr,
        hintStyle: CustomTextStyles.titleSmallMontOnPrimaryContainer_1,
        contentPadding: EdgeInsets.all(16.h),
      ),
    );
  }
  ...
  /// Section Widget
  Widget _buildFullnamethree() {
    return Padding(
      padding: EdgeInsets.only(right: 2.h),
      child: CustomTextFormField(
        controller: controller.fullnamethreeController,
        hintText: "lbl_peter".tr,
        hintStyle: CustomTextStyles.titleSmallMontOnPrimaryContainer_1,
        contentPadding: EdgeInsets.all(16.h),
      ),
    );
  ...
  Widget _buildEmail() {
    return Padding(
      ...
      child: CustomTextFormField(
        ...
        hintText: "msg_jacobpeter_gmail_com".tr,
        hintStyle: CustomTextStyles.titleSmallMontOnPrimaryContainer_1,
  ...
  Widget _buildSignup() {
    return CustomElevatedButton(
      ...
      buttonTextStyle: CustomTextStyles.titleSmallMontOnPrimaryExtraBold,
      onPressed: () {
        onTapSignup();
      },
    );
