...
class _VendorDetailScreenState extends State<VendorDetailScreen>
  ...
  void initState() {
    ...
    myLog.log('Vendor details: $vendor');
  ...
  Future<void> _load() async {
    ...
    if (res['success'] == true) {
      final data = res['data'];
      myLog.log('Vendor products data: $data');
      _products =
          (res['data']['data'] ?? data['data'] ?? data['products'] ?? [])
              as List;
      // extract categories
  ...
  List<dynamic> get _filtered {
    ...
    return _products
        .where((p) => p['category']?['name'] == _selectedCat)
        .toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final logo = vendor['logo_url']?.toString();
    ...
    final distance = vendor['distance_km']?.toString() ?? 'N/A';
                      ...
                      .map(
                        (cat) => Padding(
                          ...
                          child: AppTag(
                            ...
                            onTap: () =>
                                setState(() => _selectedCat = cat.toString()),
                          ),
                        ),
                      )
                      .toList(),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Obx(
                          () => AppButton(
                            label:
                                'Add  N${(price * qty.value).toStringAsFixed(0)}',
                            onTap: () {
                              cartCtrl.addItem(
                                CartItem(
                                  productId: productId,
