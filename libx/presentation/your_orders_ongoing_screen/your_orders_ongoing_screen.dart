...
class YourOrdersOngoingScreen extends StatefulWidget {
  ...
  @override
  State<YourOrdersOngoingScreen> createState() =>
      _YourOrdersOngoingScreenState();
}
...
class _YourOrdersOngoingScreenState extends State<YourOrdersOngoingScreen> {
  ...
  //         controller.googleMapController.complete(controller);
  //       },
                    ...
                    children: [
                      CustomIconButton(
                        ...
                        child: CustomImageView(
                          imagePath: 'assets/images/img_thumbs_up.svg',
                        ),
                      ),
                      Expanded(
                        child: Column(
