...
import '../presentation/account_information_bottomsheet/account_information_bottomsheet.dart';
import '../presentation/account_information_bottomsheet/binding/account_information_binding.dart';
import '../presentation/change_password_bottomsheet/change_password_bottomsheet.dart';
import '../presentation/change_password_bottomsheet/binding/change_password_binding.dart';
...
import '../presentation/payment_methods_bottomsheet/binding/payment_methods_binding.dart';
import '../presentation/payment_methods_bottomsheet/payment_methods_bottomsheet.dart';
import '../presentation/payment_methods_card_bottomsheet/binding/payment_methods_card_binding.dart';
import '../presentation/payment_methods_card_bottomsheet/payment_methods_card_bottomsheet.dart';
...
class AppRoutes {
  ...
  static const String accountInformationBottomsheet =
      '/account_information_bottomsheet';

  static const String changePasswordBottomsheet =
      '/change_password_bottomsheet';

  static const String paymentMethodsBottomsheet =
      '/payment_methods_bottomsheet';

  static const String paymentMethodsCardBottomsheet =
      '/payment_methods_card_bottomsheet';
  ...
  static List<GetPage> pages = [
    ...
    GetPage(name: otpScreen, page: () => OtpScreen(), bindings: [OtpBinding()]),
    GetPage(
    ...
    GetPage(
      name: accountInformationBottomsheet,
      page: () => AccountInformationBottomsheet(
        Get.find<AccountInformationController>(),
      ),
      bindings: [AccountInformationBinding()],
    ),
    GetPage(
      name: changePasswordBottomsheet,
      page: () =>
          ChangePasswordBottomsheet(Get.find<ChangePasswordController>()),
      bindings: [ChangePasswordBinding()],
    ),
    GetPage(
      name: paymentMethodsBottomsheet,
      page: () =>
          PaymentMethodsBottomsheet(Get.find<PaymentMethodsController>()),
      bindings: [PaymentMethodsBinding()],
    ),
    GetPage(
      name: paymentMethodsCardBottomsheet,
      page: () => PaymentMethodsCardBottomsheet(
        Get.find<PaymentMethodsCardController>(),
      ),
      bindings: [PaymentMethodsCardBinding()],
    ),
    GetPage(
      name: initialRoute,
      page: () => IntroSplashScreen(),
