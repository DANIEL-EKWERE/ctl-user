...
import 'modules/auth/verify/verify_screen.dart';
...
import 'modules/customer/orders/order_screen.dart';
...
import 'modules/rider/dashboard/rider_controller.dart';
import 'modules/rider/dashboard/rider_screen.dart';
...
final _pages = [
  ...
  GetPage(name: AppRoutes.customerShell, page: () => const CustomerShell(),
    binding: BindingsBuilder(() { Get.lazyPut(() => CustomerHomeController()); })),
  ...
  // Rider
  GetPage(name: AppRoutes.riderShell,       page: () => const RiderShell(),
    binding: BindingsBuilder(() { Get.lazyPut(() => RiderController()); })),
  GetPage(name: AppRoutes.riderOrderDetail, page: () => const RiderOrderDetailScreen()),
];
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
      Container(width: 80, height: 80,
        ...
        child: const Center(child: Text('NK', style: TextStyle(color: AppColors.orange, fontSize: 28, fontWeight: FontWeight.w900)))),
      const SizedBox(height: 16),
      const Text('NKsereke', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.w800)),
      const SizedBox(height: 8),
      const Text('Your local delivery platform', style: TextStyle(color: Colors.white70, fontSize: 14)),
